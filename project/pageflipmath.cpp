...
void PageFlipMath::compute(qreal t)
{
    ...
    case TopRight:
        for (page = 0; page < 4; ++page)
        {
            ...
            {
                vertices[page][vertex][1] = m_pageRect.height() - 1 - vertices[page][vertex][1];
                vertices[page][vertex][3] = 1.0f - vertices[page][vertex][3];
            }
        }
        break;
    ...
    case BottomLeft:
        for (page = 0; page < 4; ++page)
        {
            for (vertex = 0; vertex < pageCount[page]; ++vertex)
            {
                vertices[page][vertex][0] = m_pageRect.width() - 1 - vertices[page][vertex][0];
                vertices[page][vertex][0] -= m_pageRect.width();
                vertices[page][vertex][2] = 1.0f - vertices[page][vertex][2];
            }
        }
        break;
    ...
    for (page = 0; page < 4; ++page)
    {
        for (vertex = 0; vertex < pageCount[page]; ++vertex)
        {
            ...
            vertices[page][vertex][1] = m_pageRect.y() + (m_pageRect.height() - 1 - vertices[page][vertex][1]);
        }
    }
